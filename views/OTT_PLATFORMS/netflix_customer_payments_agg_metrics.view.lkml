# The name of this view in Looker is "Netflix Customer Payments Agg Metrics"
view: netflix_customer_payments_agg_metrics {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "OTT_PLATFORMS"."NETFLIX_CUSTOMER_PAYMENTS_AGG_METRICS"
    ;;
