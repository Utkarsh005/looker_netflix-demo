# The name of this view in Looker is "Netflix Watch Delay By Months"
view: netflix_watch_delay_by_months {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "OTT_PLATFORMS"."NETFLIX_WATCH_DELAY_BY_MONTHS"
    ;;
