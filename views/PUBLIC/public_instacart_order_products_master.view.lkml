# The name of this view in Looker is "Public Instacart Order Products Master"
view: public_instacart_order_products_master {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "PUBLIC"."INSTACART_ORDER_PRODUCTS_MASTER"
    ;;
