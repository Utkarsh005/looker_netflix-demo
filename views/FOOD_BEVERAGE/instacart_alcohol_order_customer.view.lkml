# The name of this view in Looker is "Instacart Alcohol Order Customer"
view: instacart_alcohol_order_customer {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "FOOD_BEVERAGE"."INSTACART_ALCOHOL_ORDER_CUSTOMER"
    ;;
