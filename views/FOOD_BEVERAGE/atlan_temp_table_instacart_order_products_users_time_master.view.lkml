# The name of this view in Looker is "Atlan Temp Table Instacart Order Products Users Time Master"
view: atlan_temp_table_instacart_order_products_users_time_master {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "FOOD_BEVERAGE"."ATLAN_TEMP_TABLE_INSTACART_ORDER_PRODUCTS_USERS_TIME_MASTER"
    ;;
