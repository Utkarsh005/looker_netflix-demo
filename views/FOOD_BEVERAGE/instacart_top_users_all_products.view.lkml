# The name of this view in Looker is "Instacart Top Users All Products"
view: instacart_top_users_all_products {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "FOOD_BEVERAGE"."INSTACART_TOP_USERS_ALL_PRODUCTS"
    ;;
