# The name of this view in Looker is "Instacart Snacks Order Customer"
view: instacart_snacks_order_customer {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "FOOD_BEVERAGE"."INSTACART_SNACKS_ORDER_CUSTOMER"
    ;;
