# The name of this view in Looker is "Instacart Top Snacks Users Orders"
view: instacart_top_snacks_users_orders {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: "FOOD_BEVERAGE"."INSTACART_TOP_SNACKS_USERS_ORDERS"
    ;;
